...
checkpointer = ModelCheckpoint(filepath=experiment_path + 'model{epoch:02d}-valloss{val_loss:.2f}-valacc{val_accuracy:.2f}.hdf5', verbose=1)
...
np.save(experiment_path + 'History.val_accuracy.npy', His.history['val_accuracy'])
